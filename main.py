# Made by:
#   Original code, updates, and owner: sussyegg#7598
...
print(Visual.textToColour(f"[COLOR_LIGHT_BLUE]UGC-Sniper made by: sussyegg#7598 (sussyegg)"
                   f"[COLOR_LIGHT_BLUE]Discord server: https://discord.gg/KDMMDXT5tC"))
time.sleep(3)


class UGCSniper:  # OMG guys he stole this from jeldo!!
    def __init__(self):
        os.system("cls" if os.name == "nt" else "clear")
        if os.name == "nt": ctypes.windll.kernel32.SetConsoleTitleW("sussyegg sniper")
